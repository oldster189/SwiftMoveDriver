...
public class JobProcessManager {
    ...
    private void loadCache() {
        SharedPreferences prefs = mContext.getSharedPreferences("DriverJobProcess",
                Context.MODE_PRIVATE);
        String json = prefs.getString("driver_job_process_data",null);
        if (json == null)
            return;
    ...
    private void saveCache() {
        ...
        editor.putString("driver_job_process_data", json);
        editor.apply();
    }
