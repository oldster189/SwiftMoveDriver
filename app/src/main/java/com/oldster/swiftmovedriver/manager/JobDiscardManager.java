...
public class JobDiscardManager {
    ...
    private void loadCache() {
        SharedPreferences prefs = mContext.getSharedPreferences("DriverJobDiscard",
                Context.MODE_PRIVATE);
        String json = prefs.getString("driver_job_discard_data",null);
        if (json == null)
            return;
    ...
    private void saveCache() {
        ...
        editor.putString("driver_job_discard_data", json);
        editor.apply();
    }
